...
// Every row this router serves is written entirely by triggers
// (trg_outbid, trg_close_auction -- db/02_triggers.sql). This router only
// ever reads and marks-as-read; it never INSERTs a notification itself.
router.get(
  '/',
  requireAuth,
